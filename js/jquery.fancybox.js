!(function (t, e) {
  ...
  class c {
    ...
    onMove(t) {
      const e = this.currentPointers.slice(),
        ...
        n = [];
      for (const t of i) {
        const e = this.currentPointers.findIndex(
          (e) => e.id === t.id
        );
  ...
  const u = (t) =>
    ...
    f = function (t, e) {
      return t
        .split(".")
        .reduce(
          (t, e) => ("object" == typeof t ? t[e] : void 0),
          e
        );
    };
  class g {
    ...
    attachPlugins(t = {}) {
      ...
      for (const [i, n] of Object.entries(t)) {
        ...
        s || !1 === t
          ? s &&
            !1 === t &&
            (s.detach(), delete this.plugins[i])
          : e.set(i, new n(this, t || {}));
      }
      for (const [t, i] of e)
        (this.plugins[t] = i), i.attach();
    }
    detachPlugins(t) {
  ...
  class D extends m {
    ...
    get isTouchDevice() {
      return (
        null === I &&
          (I = window.matchMedia("(hover: none)").matches),
        I
      );
    }
    get isMobile() {
      return (
        null === k &&
          (k = /iPhone|iPad|iPod|Android/i.test(
            navigator.userAgent
          )),
        k
      );
    ...
    get angle() {
      return (
        (180 * Math.atan2(this.current.b, this.current.a)) /
          Math.PI || 0
      );
    }
    get targetAngle() {
      return (
        (180 * Math.atan2(this.target.b, this.target.a)) /
          Math.PI || 0
      );
    }
    get scale() {
    ...
    get maxScale() {
      return (
        this.fullScale * (this.option("maxScale") || 1) || 1
      );
    }
    get coverScale() {
    ...
    get isResting() {
      ...
      return !(
        !this.ignoreBounds && !this.checkBounds().inBounds
      );
    }
    constructor(t, e = {}, i = {}) {
      var n;
      ...
      if (
        (i ||
          ((i =
            ...
            t.firstElementChild),
          i && C(i, e)),
        i instanceof HTMLPictureElement &&
    ...
    attachObserver() {
      ...
      const e = () => {
        ...
        return (
          Math.abs(
            e.width - t.getBoundingClientRect().width
          ) > 0.1 ||
          Math.abs(
            e.height - t.getBoundingClientRect().height
          ) > 0.1
        );
      };
      this.resizeObserver ||
    ...
    calculateContentDim(t = this.current) {
      ...
      if (this.option("zoom") || 0 !== this.angle) {
        const i =
            ...
            ("none" ===
              window.getComputedStyle(e).maxWidth ||
              "none" ===
                window.getComputedStyle(e).maxHeight),
          c = i ? o : n,
          h = i ? a : s,
          d = this.getMatrix(t),
    ...
    onPointerMove(t, i, s) {
      ...
      if (
        ...
        return;
      if ((this.emit("touchMove", t), t.defaultPrevented))
        return;
      ...
      this.option("rubberband")
        ? ("x" !== this.isInfinite &&
            ...
            (g *= Math.max(
              ...
              0.5 -
                Math.abs(
                  (0.75 / this.contentRect.fitWidth) *
                    b.xDiff
                )
            )),
          "y" !== this.isInfinite &&
            ...
            (m *= Math.max(
              ...
              0.5 -
                Math.abs(
                  (0.75 / this.contentRect.fitHeight) *
                    b.yDiff
                )
            )))
    ...
    startDecelAnim() {
      ...
      Math.abs(m) < y &&
        ...
        ((h = d = 0), (u = p = 0)),
        ((this.option("zoom") &&
          (g < this.minScale - 1e-5 ||
            g > this.maxScale + 1e-5)) ||
          (i && !h && !d)) &&
          (f = 0.35),
    ...
    onWheel(t) {
      ...
      if ((this.emit("wheel", t, i), this.panMode === A))
        return;
    ...
    panWithMouse(t, i = this.option("mouseMoveFriction")) {
      if (((this.pmme = t), this.panMode !== A || !t))
        return;
      ...
      p > 1 && (d !== a && (d *= p), u !== r && (u *= p));
      let f =
        0.5 * (d - a) - (((c / a) * 100) / 100) * (d - a);
      f += 0.5 * (o.right - o.left);
      let g =
        0.5 * (u - r) - (((h / r) * 100) / 100) * (u - r);
    ...
    zoomTo(
      ...
      "number" == typeof t
        ...
        ? (c = 1)
        : "next" === t &&
          (c = this.getNextScale("iterateZoom")),
        (c = c / o || 1),
    ...
    fitX() {
      ...
      this.applyChange({
        panX:
          0.5 * t.width - (e.left + 0.5 * e.fitWidth) - i.e,
        panY:
          0.5 * t.height -
          (e.top + 0.5 * e.fitHeight) -
          i.f,
  ...
  class U extends $ {
    ...
    onNavTouch(t, e, i) {
      var n, s;
      if (
        Math.abs(e.dragOffset.x) > 3 ||
        Math.abs(e.dragOffset.y) > 3
      )
        return;
      const o = i.target,
        { nav: a, target: r } = this;
      ...
      if ((i.stopPropagation(), i.preventDefault(), !l))
        return;
  ...
  class tt extends m {
    ...
    getSlideMetrics(t) {
      ...
      if (
        ...
        C(
          r,
          this.cn(Q) + " " + t.class + " " + t.customClass
        ),
        o)
      )
        (r.style[s] = `${o}px`),
    ...
    manageSlideVisiblity() {
      ...
      for (const e of this.inTransition)
        t.add(this.slides[e]);
      for (const e of t)
        this.createSlideEl(e), this.lazyLoadSlide(e);
    ...
    lazyLoadImg(t, e) {
      ...
      C(e, o),
        (e.src =
          e.dataset.lazySrcset || e.dataset.lazySrc || ""),
      ...
      if (this.isInfinite) {
        ...
        if (2 === c)
          ...
          d = [d, d - e, d + e].reduce(function (t, e) {
            return Math.abs(e - i) < Math.abs(t - i)
              ? e
              : t;
          });
        }
    ...
    addSlide(t, e) {
      ...
      const a = this.panzoom,
        r =
          (null === (i = this.pages[this.page]) ||
          void 0 === i
            ? void 0
            : i.pos) || 0,
        l =
          (null === (n = this.pages[this.page]) ||
          void 0 === n
            ? void 0
            : n.dim) || 0,
      ...
      if (
        ...
        const e =
            (null === (s = this.pages[this.page]) ||
            void 0 === s
              ? void 0
              : s.pos) || 0,
          i =
            (null === (o = this.pages[this.page]) ||
            void 0 === o
              ? void 0
              : o.dim) || 0,
    ...
    updateMetrics() {
      ...
      if (i) {
        let t = Math.max(
            i[l],
            e(i.getBoundingClientRect()[r], 1e3)
          ),
      ...
      for (const [t, i] of s.entries()) {
        ...
        !i.el && c
          ? ((n = c.dim), (o = c.gap))
          : (({ dim: n, gap: o } = this.getSlideMetrics(i)),
            (c = i)),
          (n = e(n, 1e3)),
          (o = e(o, 1e3)),
          (i.dim = n),
      ...
      (h = e(h, 1e3)),
        ...
        t &&
          ((t.contentRect[r] = h),
          (t.contentRect[o ? "fullWidth" : "fullHeight"] =
            h)),
    ...
    getPageFromPosition(t) {
      ...
      let d = 0,
        ...
        f =
          void 0 === t
            ? -1 *
              ((null == o ? void 0 : o.target[this.axis]) ||
                0)
            : t;
      h && (f += 0.5 * e),
        this.isInfinite
      ...
      (t.src = e),
        this.process(t, e).then(
          (e) => {
            ...
            n.offsetHeight;
            const r =
              !!i.isOpeningSlide(t) && this.getZoomInfo(t);
        ...
        if (
          ...
          if (
            ...
            (i =
              ...
              (l.draggable = !1),
              t.srcset &&
                l.setAttribute("srcset", t.srcset),
        ...
        t.panzoom = new D(
          ...
          p(
            ...
            this.option("Panzoom") || {},
            {
              content: l,
              width: (e, i) =>
                a.optionFor(t, "width", "auto", i) ||
                "auto",
              height: (e, i) =>
                a.optionFor(t, "height", "auto", i) ||
                "auto",
              wheel: () => {
  ...
  class zt extends $ {
    ...
    onRefresh(t, e) {
      e.slides.forEach((t) => {
        t.el &&
          (this.resizeIframe(t), this.setAspectRatio(t));
      });
    }
    onMessage(t) {
      try {
    ...
    setIframeContent(t) {
      ...
      (s.className = "fancybox__iframe"),
        s.setAttribute(
          "id",
          `fancybox__iframe_${n.id}_${t.index}`
        );
  ...
  let Wt = class extends $ {
    ...
    onInitSlide(t, e) {
      ...
      i &&
        ...
        (e[_t] =
          parseFloat(i.thumbHeight || "") || e[_t] || 0)),
        this.addSlide(e);
    }
    onInitSlides() {
      this.build();
        ...
        if (n.isDragging) {
          ...
          let n =
            (null === (t = s.pages[r]) || void 0 === t
              ...
              : t.pos) || 0;
          n +=
            i.getProgress(r) * (this[$t] + this.thumbGap);
          let a = o.getBounds();
          -1 * n > a.x.min &&
            -1 * n < a.x.max &&
  ...
  class Vt extends $ {
    ...
    onInit() {
      ...
      if (e.ref || !n) return;
      const s =
        e.option("parentEl") || i.footer || i.container;
      if (!s) return;
      const o = p({}, e.options, {
        parentEl: s,
  ...
  class te extends $ {
    ...
    onDone(t, e) {
      ...
      null === (i = e.panzoom) ||
        void 0 === i ||
        i.on("afterTransform", () => {
          this.instance.isCurrentSlide(e) &&
            this.onRefresh();
        }),
    ...
    createEl(t) {
      ...
      if (void 0 !== Zt[t]) {
        ...
        (n = document.createElement("button")),
          ...
          e.change &&
            (n.dataset.panzoomChange = JSON.stringify(
              e.change
            )),
  ...
  class Ae extends m {
      ...
      const s = (this.carousel = new tt(
        ...
        p(
          {},
          {
            ...
            transition: "fade",
            Panzoom: {
              lockAxis: this.option("dragToClose")
                ? "xy"
                : "x",
    ...
    onClick(t) {
      ...
      if (
        Math.abs(t.pageX - Se) > 30 ||
        Math.abs(t.pageY - Pe) > 30
      )
        return;
    ...
    manageCaption(t = void 0) {
      ...
      P(s, ue);
      const o =
          this.isCompact || this.option("commonCaption"),
        a = !o;
      if (
        ...
        for (const t of (null === (e = this.carousel) ||
        void 0 === e
          ? void 0
          : e.slides) || [])
          t.captionEl &&
    ...
    setContent(t, e = "", i = !0) {
      ...
      S(o) &&
        t.filter &&
        !t.error &&
        (o = o.querySelector(t.filter)),
        o && S(o)
          ? (C(o, "fancybox__content"),
            t.id && o.setAttribute("id", t.id),
            n.classList.add(
              `has-${
                t.error ? "error" : t.type || "unknown"
              }`
            ),
            n.prepend(o),
    ...
    clearContent(t) {
      ...
      this.emit("clearContent", t),
        t.contentEl &&
          (t.contentEl.remove(), (t.contentEl = void 0));
      const e = t.el;
      e &&
        (P(e, "has-error"),
        P(e, "has-unknown"),
    ...
    close(t, e) {
      ...
      if (
        (this.emit("shouldClose", i, t), i.defaultPrevented)
      )
        return;
      t &&
        t.cancelable &&
    ...
    static bind(t, e, i) {
      ...
      a.set(s, o),
        Ae.openers.set(n, a),
        1 === a.size &&
          n.addEventListener("click", Ae.fromEvent);
    }
    static unbind(t, e) {
      let i,
        n = "";
    ...
    static fromEvent(t) {
      ...
      if (i) {
        const t = i.dataset.fancyboxTrigger || "",
          ...
          s =
            parseInt(i.dataset.fancyboxIndex || "", 10) ||
            0;
        e = n[s] || e;
      }
      ...
      if (
        ((!e || d || c) &&
          (r = [].slice.call(n.querySelectorAll(s))),
        e &&
          !c &&
          (r = d
    ...
    static fromSelector(t, e, i) {
      ...
      return (
        ...
        !!o &&
          Ae.fromNodes(
            Array.from(n.querySelectorAll(s)),
            o
          ))
      );
    }
